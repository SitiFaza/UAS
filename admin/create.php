...
<head>
  ...
  <style>
    ...
    .form-select option:disabled {
      color: gray;
      /* Change color of the disabled placeholder option */
    }
  </style>
</head>
...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.php">SITI FAZA ANASYA</a>
    <!-- Sidebar Toggle-->
            ...
            <div class="card-body">
              <form action="../controller/create.php" method="POST" enctype="multipart/form-data">
                <div class="input-group flex-nowrap mb-3">
                  <input type="text" class="form-control" placeholder="author" aria-label="author" name="judul"
                    aria-describedby="addon-wrapping">
                </div>
                <div class="mb-3">
                  <!-- <label for="kategori" class="label-gray">Kategori</label> -->
                  <select class="form-select" name="kategori" id="kategori" required>
                    ...
                    <option value="Technology Posts">Technology Posts</option>
                  </select>
                </div>

                <div class="input-group flex-nowrap mb-3">
                  <input type="text" class="form-control" placeholder="Judul" aria-label="Judul" name="author"
                    aria-describedby="addon-wrapping">
                </div>
                <div class="form-floating mb-3">
                  <textarea class="form-control" placeholder="isi artikel" id="floatingTextarea"
                    name="deskripsi"></textarea>
                  <label for="floatingTextarea" style="color: gray;">Isi Artikel</label>
                </div>
                <div class="input-group flex-nowrap mb-3">
